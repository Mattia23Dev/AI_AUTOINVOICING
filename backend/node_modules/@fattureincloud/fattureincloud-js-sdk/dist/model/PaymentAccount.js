...
var _PaymentAccountType = _interopRequireDefault(require("./PaymentAccountType"));
 ...
 * @version 2.0.24
 */
var PaymentAccount = /*#__PURE__*/function () {
  /**
  ...
  /**
     ...
     */
  _createClass(PaymentAccount, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('type')) {
          obj.type = _PaymentAccountType["default"].constructFromObject(data.type);
        }
        if (data.hasOwnProperty('iban')) {
          obj.iban = _ApiClient["default"].convertToType(data.iban, 'String');
        }
        if (data.hasOwnProperty('sia')) {
          obj.sia = _ApiClient["default"].convertToType(data.sia, 'String');
        }
        if (data.hasOwnProperty('cuc')) {
          obj.cuc = _ApiClient["default"].convertToType(data.cuc, 'String');
        }
...
var _default = exports["default"] = PaymentAccount;