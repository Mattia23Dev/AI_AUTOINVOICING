 ...
 * @version 2.0.24
 */
var GetUserInfoResponseInfo = /*#__PURE__*/function () {
  /**
     * Constructs a new <code>GetUserInfoResponseInfo</code>.
     * @alias module:model/GetUserInfoResponseInfo
     */
  function GetUserInfoResponseInfo() {
    _classCallCheck(this, GetUserInfoResponseInfo);
  ...
  /**
     ...
     */
  _createClass(GetUserInfoResponseInfo, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('need_marketing_consents_confirmation')) {
          obj.need_marketing_consents_confirmation = _ApiClient["default"].convertToType(data.need_marketing_consents_confirmation, 'Boolean');
        }
        if (data.hasOwnProperty('need_password_change')) {
          obj.need_password_change = _ApiClient["default"].convertToType(data.need_password_change, 'Boolean');
        }
        if (data.hasOwnProperty('need_terms_of_service_confirmation')) {
          obj.need_terms_of_service_confirmation = _ApiClient["default"].convertToType(data.need_terms_of_service_confirmation, 'Boolean');
        }
      }
      return obj;
    }
  ...
  return GetUserInfoResponseInfo;
}();
/**
...
var _default = exports["default"] = GetUserInfoResponseInfo;