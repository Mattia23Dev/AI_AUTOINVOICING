...
var _ReceivedDocumentPaymentsListItemPaymentTerms = _interopRequireDefault(require("./ReceivedDocumentPaymentsListItemPaymentTerms"));
 ...
 * @version 2.0.24
 */
var ReceivedDocumentPaymentsListItem = /*#__PURE__*/function () {
  /**
     * Constructs a new <code>ReceivedDocumentPaymentsListItem</code>.
     * @alias module:model/ReceivedDocumentPaymentsListItem
     */
  function ReceivedDocumentPaymentsListItem() {
    _classCallCheck(this, ReceivedDocumentPaymentsListItem);
  ...
  /**
     ...
     */
  _createClass(ReceivedDocumentPaymentsListItem, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('payment_terms')) {
          obj.payment_terms = _ReceivedDocumentPaymentsListItemPaymentTerms["default"].constructFromObject(data.payment_terms);
        }
    ...
    value: function validateJSON(data) {
      ...
      if (data.payment_terms) {
        // data not null
        _ReceivedDocumentPaymentsListItemPaymentTerms["default"].validateJSON(data.payment_terms);
      }
  ...
  return ReceivedDocumentPaymentsListItem;
}();
/**
...
var _default = exports["default"] = ReceivedDocumentPaymentsListItem;