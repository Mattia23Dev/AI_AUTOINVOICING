 ...
 * @version 2.0.24
 */
var IssuedDocumentPreCreateInfoDefaultValues = /*#__PURE__*/function () {
  /**
     ...
     */
  function IssuedDocumentPreCreateInfoDefaultValues() {
    _classCallCheck(this, IssuedDocumentPreCreateInfoDefaultValues);
  ...
  /**
     ...
     */
  _createClass(IssuedDocumentPreCreateInfoDefaultValues, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('default_template')) {
          obj.default_template = _DocumentTemplate["default"].constructFromObject(data.default_template);
        }
        if (data.hasOwnProperty('dn_template')) {
          obj.dn_template = _DocumentTemplate["default"].constructFromObject(data.dn_template);
        }
        if (data.hasOwnProperty('ai_template')) {
          obj.ai_template = _DocumentTemplate["default"].constructFromObject(data.ai_template);
        }
    ...
    value: function validateJSON(data) {
      ...
      if (data.default_template) {
        // data not null
        _DocumentTemplate["default"].validateJSON(data.default_template);
      }
      // validate the optional field `dn_template`
      if (data.dn_template) {
        // data not null
        _DocumentTemplate["default"].validateJSON(data.dn_template);
      }
      // validate the optional field `ai_template`
      if (data.ai_template) {
        // data not null
        _DocumentTemplate["default"].validateJSON(data.ai_template);
      }
  ...
  return IssuedDocumentPreCreateInfoDefaultValues;
}();
/**
...
var _default = exports["default"] = IssuedDocumentPreCreateInfoDefaultValues;