 ...
 * @version 2.0.24
 */
var EmailScheduleInclude = /*#__PURE__*/function () {
  /**
     * Constructs a new <code>EmailScheduleInclude</code>.
     * @alias module:model/EmailScheduleInclude
     */
  function EmailScheduleInclude() {
    _classCallCheck(this, EmailScheduleInclude);
  ...
  /**
     ...
     */
  _createClass(EmailScheduleInclude, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('document')) {
          obj.document = _ApiClient["default"].convertToType(data.document, 'Boolean');
        }
        if (data.hasOwnProperty('delivery_note')) {
          obj.delivery_note = _ApiClient["default"].convertToType(data.delivery_note, 'Boolean');
        }
        if (data.hasOwnProperty('attachment')) {
          obj.attachment = _ApiClient["default"].convertToType(data.attachment, 'Boolean');
        }
...
var _default = exports["default"] = EmailScheduleInclude;