...
var _WebhooksSubscriptionConfig = _interopRequireDefault(require("./WebhooksSubscriptionConfig"));
...
var WebhooksSubscription = /*#__PURE__*/function () {
  ...
  /**
     ...
     */
  _createClass(WebhooksSubscription, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('sink')) {
          obj.sink = _ApiClient["default"].convertToType(data.sink, 'String');
        }
        if (data.hasOwnProperty('verified')) {
          obj.verified = _ApiClient["default"].convertToType(data.verified, 'Boolean');
        }
        if (data.hasOwnProperty('types')) {
          obj.types = _ApiClient["default"].convertToType(data.types, [_EventType["default"]]);
        }
        if (data.hasOwnProperty('config')) {
          obj.config = _WebhooksSubscriptionConfig["default"].constructFromObject(data.config);
        }
      }
      return obj;
    }
    ...
    value: function validateJSON(data) {
      ...
      if (data.config) {
        // data not null
        _WebhooksSubscriptionConfig["default"].validateJSON(data.config);
      }
      return true;
    }
  }]);
...
var _default = exports["default"] = WebhooksSubscription;