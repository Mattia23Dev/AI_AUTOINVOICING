...
var _EmailDataDefaultSenderEmail = _interopRequireDefault(require("./EmailDataDefaultSenderEmail"));
var _SenderEmail = _interopRequireDefault(require("./SenderEmail"));
...
var EmailData = /*#__PURE__*/function () {
  ...
  _createClass(EmailData, null, [{
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('recipient_email')) {
          obj.recipient_email = _ApiClient["default"].convertToType(data.recipient_email, 'String');
        }
        if (data.hasOwnProperty('default_sender_email')) {
          obj.default_sender_email = _EmailDataDefaultSenderEmail["default"].constructFromObject(data.default_sender_email);
        }
        if (data.hasOwnProperty('sender_emails_list')) {
          obj.sender_emails_list = _ApiClient["default"].convertToType(data.sender_emails_list, [_SenderEmail["default"]]);
        }
        ...
        if (data.hasOwnProperty('document_exists')) {
          obj.document_exists = _ApiClient["default"].convertToType(data.document_exists, 'Boolean');
        }
        if (data.hasOwnProperty('delivery_note_exists')) {
          obj.delivery_note_exists = _ApiClient["default"].convertToType(data.delivery_note_exists, 'Boolean');
        }
        if (data.hasOwnProperty('attachment_exists')) {
          obj.attachment_exists = _ApiClient["default"].convertToType(data.attachment_exists, 'Boolean');
        }
        if (data.hasOwnProperty('accompanying_invoice_exists')) {
          obj.accompanying_invoice_exists = _ApiClient["default"].convertToType(data.accompanying_invoice_exists, 'Boolean');
        }
        if (data.hasOwnProperty('default_attach_pdf')) {
          obj.default_attach_pdf = _ApiClient["default"].convertToType(data.default_attach_pdf, 'Boolean');
        }
      }
      return obj;
    }
    ...
    value: function validateJSON(data) {
      ...
      if (data.default_sender_email) {
        // data not null
        _EmailDataDefaultSenderEmail["default"].validateJSON(data.default_sender_email);
      }
      if (data.sender_emails_list) {
        // data not null
        ...
        var _iterator = _createForOfIteratorHelper(data.sender_emails_list),
          _step;
        try {
          for (_iterator.s(); !(_step = _iterator.n()).done;) {
            var item = _step.value;
            _SenderEmail["default"].validateJSON(item);
          }
        } catch (err) {
          _iterator.e(err);
        } finally {
...
var _default = exports["default"] = EmailData;