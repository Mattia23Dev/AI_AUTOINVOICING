...
var _ReceivedDocumentInfoDefaultValues = _interopRequireDefault(require("./ReceivedDocumentInfoDefaultValues"));
var _ReceivedDocumentInfoItemsDefaultValues = _interopRequireDefault(require("./ReceivedDocumentInfoItemsDefaultValues"));
 ...
 * @version 2.0.24
 */
var ReceivedDocumentInfo = /*#__PURE__*/function () {
  /**
     * Constructs a new <code>ReceivedDocumentInfo</code>.
     * @alias module:model/ReceivedDocumentInfo
     */
  function ReceivedDocumentInfo() {
    _classCallCheck(this, ReceivedDocumentInfo);
  ...
  /**
     ...
     */
  _createClass(ReceivedDocumentInfo, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('default_values')) {
          obj.default_values = _ReceivedDocumentInfoDefaultValues["default"].constructFromObject(data.default_values);
        }
        if (data.hasOwnProperty('items_default_values')) {
          obj.items_default_values = _ReceivedDocumentInfoItemsDefaultValues["default"].constructFromObject(data.items_default_values);
        }
    ...
    value: function validateJSON(data) {
      ...
      if (data.default_values) {
        // data not null
        _ReceivedDocumentInfoDefaultValues["default"].validateJSON(data.default_values);
      }
      // validate the optional field `items_default_values`
      if (data.items_default_values) {
        // data not null
        _ReceivedDocumentInfoItemsDefaultValues["default"].validateJSON(data.items_default_values);
      }
      ...
      if (data.payment_accounts_list) {
        ...
        var _iterator2 = _createForOfIteratorHelper(data.payment_accounts_list),
          _step2;
        try {
          for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
            var _item = _step2.value;
            _PaymentAccount["default"].validateJSON(_item);
          }
        } catch (err) {
          _iterator2.e(err);
        } finally {
      ...
      if (data.vat_types_list) {
        ...
        var _iterator3 = _createForOfIteratorHelper(data.vat_types_list),
          _step3;
        try {
          for (_iterator3.s(); !(_step3 = _iterator3.n()).done;) {
            var _item2 = _step3.value;
            _VatType["default"].validateJSON(_item2);
          }
        } catch (err) {
          _iterator3.e(err);
        } finally {
...
var _default = exports["default"] = ReceivedDocumentInfo;