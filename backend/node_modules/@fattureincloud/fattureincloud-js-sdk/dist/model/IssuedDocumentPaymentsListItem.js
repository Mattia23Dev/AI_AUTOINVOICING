...
var _IssuedDocumentPaymentsListItemPaymentTerms = _interopRequireDefault(require("./IssuedDocumentPaymentsListItemPaymentTerms"));
var _IssuedDocumentStatus = _interopRequireDefault(require("./IssuedDocumentStatus"));
 ...
 * @version 2.0.24
 */
var IssuedDocumentPaymentsListItem = /*#__PURE__*/function () {
  /**
     * Constructs a new <code>IssuedDocumentPaymentsListItem</code>.
     * @alias module:model/IssuedDocumentPaymentsListItem
     */
  function IssuedDocumentPaymentsListItem() {
    _classCallCheck(this, IssuedDocumentPaymentsListItem);
  ...
  /**
     ...
     */
  _createClass(IssuedDocumentPaymentsListItem, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('status')) {
          obj.status = _IssuedDocumentStatus["default"].constructFromObject(data.status);
        }
        if (data.hasOwnProperty('payment_account')) {
          obj.payment_account = _PaymentAccount["default"].constructFromObject(data.payment_account);
        }
        if (data.hasOwnProperty('paid_date')) {
          obj.paid_date = _ApiClient["default"].convertToType(data.paid_date, 'Date');
        }
        ...
        if (data.hasOwnProperty('payment_terms')) {
          obj.payment_terms = _IssuedDocumentPaymentsListItemPaymentTerms["default"].constructFromObject(data.payment_terms);
        }
      }
      return obj;
    }
    ...
    value: function validateJSON(data) {
      ...
      if (data.payment_account) {
        // data not null
        _PaymentAccount["default"].validateJSON(data.payment_account);
      }
      // validate the optional field `payment_terms`
      if (data.payment_terms) {
        // data not null
        _IssuedDocumentPaymentsListItemPaymentTerms["default"].validateJSON(data.payment_terms);
      }
      return true;
    }
  }]);
  return IssuedDocumentPaymentsListItem;
}();
/**
...
var _default = exports["default"] = IssuedDocumentPaymentsListItem;