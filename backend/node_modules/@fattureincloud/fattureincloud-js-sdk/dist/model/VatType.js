    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('ei_type')) {
          obj.ei_type = _ApiClient["default"].convertToType(data.ei_type, 'String');
        }
        if (data.hasOwnProperty('ei_description')) {
          obj.ei_description = _ApiClient["default"].convertToType(data.ei_description, 'String');
        }
        if (data.hasOwnProperty('editable')) {
          obj.editable = _ApiClient["default"].convertToType(data.editable, 'Boolean');
        }
        if (data.hasOwnProperty('is_disabled')) {
          obj.is_disabled = _ApiClient["default"].convertToType(data.is_disabled, 'Boolean');
        }
      }
      return obj;
    }
...
var _default = exports["default"] = VatType;