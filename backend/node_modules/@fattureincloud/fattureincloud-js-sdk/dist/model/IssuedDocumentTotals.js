...
var _VatItem = _interopRequireDefault(require("./VatItem"));
 ...
 * @version 2.0.24
 */
var IssuedDocumentTotals = /*#__PURE__*/function () {
  /**
     * Constructs a new <code>IssuedDocumentTotals</code>.
     * @alias module:model/IssuedDocumentTotals
     */
  function IssuedDocumentTotals() {
    _classCallCheck(this, IssuedDocumentTotals);
  ...
  /**
     ...
     */
  _createClass(IssuedDocumentTotals, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('amount_net_with_rivalsa')) {
          obj.amount_net_with_rivalsa = _ApiClient["default"].convertToType(data.amount_net_with_rivalsa, 'Number');
        }
        ...
        if (data.hasOwnProperty('taxable_amount')) {
          obj.taxable_amount = _ApiClient["default"].convertToType(data.taxable_amount, 'Number');
        }
        if (data.hasOwnProperty('not_taxable_amount')) {
          obj.not_taxable_amount = _ApiClient["default"].convertToType(data.not_taxable_amount, 'Number');
        }
        ...
        if (data.hasOwnProperty('taxable_amount_withholding_tax')) {
          obj.taxable_amount_withholding_tax = _ApiClient["default"].convertToType(data.taxable_amount_withholding_tax, 'Number');
        }
        ...
        if (data.hasOwnProperty('taxable_amount_other_withholding_tax')) {
          obj.taxable_amount_other_withholding_tax = _ApiClient["default"].convertToType(data.taxable_amount_other_withholding_tax, 'Number');
        }
        ...
        if (data.hasOwnProperty('amount_due')) {
          obj.amount_due = _ApiClient["default"].convertToType(data.amount_due, 'Number');
        }
        if (data.hasOwnProperty('is_enasarco_maximal_exceeded')) {
          obj.is_enasarco_maximal_exceeded = _ApiClient["default"].convertToType(data.is_enasarco_maximal_exceeded, 'Boolean');
        }
        if (data.hasOwnProperty('payments_sum')) {
          obj.payments_sum = _ApiClient["default"].convertToType(data.payments_sum, 'Number');
        }
        if (data.hasOwnProperty('vat_list')) {
          obj.vat_list = _ApiClient["default"].convertToType(data.vat_list, {
            String: _VatItem["default"]
          });
        }
      }
      return obj;
...
var _default = exports["default"] = IssuedDocumentTotals;