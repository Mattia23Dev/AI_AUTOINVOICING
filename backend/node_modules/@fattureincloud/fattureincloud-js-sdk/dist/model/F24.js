...
var _F24Status = _interopRequireDefault(require("./F24Status"));
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('status')) {
          obj.status = _F24Status["default"].constructFromObject(data.status);
        }
...
var _default = exports["default"] = F24;