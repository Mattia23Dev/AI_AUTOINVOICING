...
var DetailedCountry = /*#__PURE__*/function () {
  ...
  /**
     ...
     */
  _createClass(DetailedCountry, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('settings_name')) {
          obj.settings_name = _ApiClient["default"].convertToType(data.settings_name, 'String');
        }
        if (data.hasOwnProperty('iso')) {
          obj.iso = _ApiClient["default"].convertToType(data.iso, 'String');
        }
        if (data.hasOwnProperty('fiscal_iso')) {
          obj.fiscal_iso = _ApiClient["default"].convertToType(data.fiscal_iso, 'String');
        }
        if (data.hasOwnProperty('uic')) {
          obj.uic = _ApiClient["default"].convertToType(data.uic, 'String');
        }
      }
      return obj;
    }
...
var _default = exports["default"] = DetailedCountry;