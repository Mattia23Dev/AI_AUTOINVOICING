...
var _OriginalDocumentType = _interopRequireDefault(require("./OriginalDocumentType"));
var _VatKind = _interopRequireDefault(require("./VatKind"));
 ...
 * @version 2.0.24
 */
var IssuedDocumentEiData = /*#__PURE__*/function () {
  /**
     ...
     */
  function IssuedDocumentEiData() {
    _classCallCheck(this, IssuedDocumentEiData);
  ...
  /**
     ...
     */
  _createClass(IssuedDocumentEiData, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('vat_kind')) {
          obj.vat_kind = _VatKind["default"].constructFromObject(data.vat_kind);
        }
        if (data.hasOwnProperty('original_document_type')) {
          obj.original_document_type = _OriginalDocumentType["default"].constructFromObject(data.original_document_type);
        }
        if (data.hasOwnProperty('od_number')) {
          obj.od_number = _ApiClient["default"].convertToType(data.od_number, 'String');
        }
        if (data.hasOwnProperty('od_date')) {
          obj.od_date = _ApiClient["default"].convertToType(data.od_date, 'Date');
        }
        if (data.hasOwnProperty('cig')) {
          obj.cig = _ApiClient["default"].convertToType(data.cig, 'String');
        }
        if (data.hasOwnProperty('cup')) {
          obj.cup = _ApiClient["default"].convertToType(data.cup, 'String');
        }
        ...
        if (data.hasOwnProperty('bank_beneficiary')) {
          obj.bank_beneficiary = _ApiClient["default"].convertToType(data.bank_beneficiary, 'String');
        }
        ...
        if (data.hasOwnProperty('invoice_date')) {
          obj.invoice_date = _ApiClient["default"].convertToType(data.invoice_date, 'Date');
        }
      }
      return obj;
    }
...
var _default = exports["default"] = IssuedDocumentEiData;