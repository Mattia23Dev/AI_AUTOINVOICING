 ...
 * @version 2.0.24
 */
var IssuedDocumentItemsListItem = /*#__PURE__*/function () {
  /**
     * Constructs a new <code>IssuedDocumentItemsListItem</code>.
     * @alias module:model/IssuedDocumentItemsListItem
     */
  function IssuedDocumentItemsListItem() {
    _classCallCheck(this, IssuedDocumentItemsListItem);
  ...
  /**
     ...
     */
  _createClass(IssuedDocumentItemsListItem, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('not_taxable')) {
          obj.not_taxable = _ApiClient["default"].convertToType(data.not_taxable, 'Boolean');
        }
        if (data.hasOwnProperty('apply_withholding_taxes')) {
          obj.apply_withholding_taxes = _ApiClient["default"].convertToType(data.apply_withholding_taxes, 'Boolean');
        }
        ...
        if (data.hasOwnProperty('in_dn')) {
          obj.in_dn = _ApiClient["default"].convertToType(data.in_dn, 'Boolean');
        }
  ...
  return IssuedDocumentItemsListItem;
}();
/**
...
var _default = exports["default"] = IssuedDocumentItemsListItem;