...
var _EmailScheduleInclude = _interopRequireDefault(require("./EmailScheduleInclude"));
...
var EmailSchedule = /*#__PURE__*/function () {
  ...
  /**
     ...
     */
  _createClass(EmailSchedule, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('sender_email')) {
          obj.sender_email = _ApiClient["default"].convertToType(data.sender_email, 'String');
        }
        ...
        if (data.hasOwnProperty('include')) {
          obj.include = _EmailScheduleInclude["default"].constructFromObject(data.include);
        }
        if (data.hasOwnProperty('attach_pdf')) {
          obj.attach_pdf = _ApiClient["default"].convertToType(data.attach_pdf, 'Boolean');
        }
        if (data.hasOwnProperty('send_copy')) {
          obj.send_copy = _ApiClient["default"].convertToType(data.send_copy, 'Boolean');
        }
      }
      return obj;
    }
    ...
    value: function validateJSON(data) {
      ...
      if (data.include) {
        // data not null
        _EmailScheduleInclude["default"].validateJSON(data.include);
      }
      return true;
    }
  }]);
...
var _default = exports["default"] = EmailSchedule;