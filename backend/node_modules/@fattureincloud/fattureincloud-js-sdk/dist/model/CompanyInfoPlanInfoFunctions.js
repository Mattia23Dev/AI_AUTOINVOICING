 ...
 * @version 2.0.24
 */
var CompanyInfoPlanInfoFunctions = /*#__PURE__*/function () {
  /**
     ...
     */
  function CompanyInfoPlanInfoFunctions() {
    _classCallCheck(this, CompanyInfoPlanInfoFunctions);
  ...
  /**
     ...
     */
  _createClass(CompanyInfoPlanInfoFunctions, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('archive')) {
          obj.archive = _ApiClient["default"].convertToType(data.archive, 'Boolean');
        }
        if (data.hasOwnProperty('cerved')) {
          obj.cerved = _ApiClient["default"].convertToType(data.cerved, 'Boolean');
        }
        if (data.hasOwnProperty('document_attachments')) {
          obj.document_attachments = _ApiClient["default"].convertToType(data.document_attachments, 'Boolean');
        }
        ...
        if (data.hasOwnProperty('genius')) {
          obj.genius = _ApiClient["default"].convertToType(data.genius, 'Boolean');
        }
        if (data.hasOwnProperty('mail_tracking')) {
          obj.mail_tracking = _ApiClient["default"].convertToType(data.mail_tracking, 'Boolean');
        }
        if (data.hasOwnProperty('payment_notifications')) {
          obj.payment_notifications = _ApiClient["default"].convertToType(data.payment_notifications, 'Boolean');
        }
        if (data.hasOwnProperty('paypal')) {
          obj.paypal = _ApiClient["default"].convertToType(data.paypal, 'Boolean');
        }
        if (data.hasOwnProperty('receipts')) {
          obj.receipts = _ApiClient["default"].convertToType(data.receipts, 'Boolean');
        }
        ...
        if (data.hasOwnProperty('smtp')) {
          obj.smtp = _ApiClient["default"].convertToType(data.smtp, 'Boolean');
        }
        if (data.hasOwnProperty('sofort')) {
          obj.sofort = _ApiClient["default"].convertToType(data.sofort, 'Boolean');
        }
        if (data.hasOwnProperty('stock')) {
          obj.stock = _ApiClient["default"].convertToType(data.stock, 'Boolean');
        }
        if (data.hasOwnProperty('subaccounts')) {
          obj.subaccounts = _ApiClient["default"].convertToType(data.subaccounts, 'Boolean');
        }
        if (data.hasOwnProperty('tessera_sanitaria')) {
          obj.tessera_sanitaria = _ApiClient["default"].convertToType(data.tessera_sanitaria, 'Boolean');
        }
        if (data.hasOwnProperty('ts_digital')) {
          obj.ts_digital = _ApiClient["default"].convertToType(data.ts_digital, 'Boolean');
        }
        if (data.hasOwnProperty('ts_invoice_trading')) {
          obj.ts_invoice_trading = _ApiClient["default"].convertToType(data.ts_invoice_trading, 'Boolean');
        }
        if (data.hasOwnProperty('ts_pay')) {
          obj.ts_pay = _ApiClient["default"].convertToType(data.ts_pay, 'Boolean');
        }
      }
      return obj;
    }
  ...
  return CompanyInfoPlanInfoFunctions;
}();
/**
...
var _default = exports["default"] = CompanyInfoPlanInfoFunctions;