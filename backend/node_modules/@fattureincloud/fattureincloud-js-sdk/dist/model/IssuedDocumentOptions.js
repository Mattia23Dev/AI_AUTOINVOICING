 ...
 * @version 2.0.24
 */
var IssuedDocumentOptions = /*#__PURE__*/function () {
  /**
     * Constructs a new <code>IssuedDocumentOptions</code>.
     * @alias module:model/IssuedDocumentOptions
     */
  function IssuedDocumentOptions() {
    _classCallCheck(this, IssuedDocumentOptions);
  ...
  /**
     ...
     */
  _createClass(IssuedDocumentOptions, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('fix_payments')) {
          obj.fix_payments = _ApiClient["default"].convertToType(data.fix_payments, 'Boolean');
        }
        if (data.hasOwnProperty('create_from')) {
          obj.create_from = _ApiClient["default"].convertToType(data.create_from, ['String']);
        }
        if (data.hasOwnProperty('transform')) {
          obj.transform = _ApiClient["default"].convertToType(data.transform, 'Boolean');
        }
        if (data.hasOwnProperty('keep_copy')) {
          obj.keep_copy = _ApiClient["default"].convertToType(data.keep_copy, 'Boolean');
        }
        if (data.hasOwnProperty('join_type')) {
          obj.join_type = _ApiClient["default"].convertToType(data.join_type, 'String');
        }
      }
      return obj;
    }
...
var _default = exports["default"] = IssuedDocumentOptions;