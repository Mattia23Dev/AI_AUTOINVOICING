 ...
 * @version 2.0.24
 */
var PermissionsFicIssuedDocumentsDetailed = /*#__PURE__*/function () {
  /**
     * Constructs a new <code>PermissionsFicIssuedDocumentsDetailed</code>.
     * @alias module:model/PermissionsFicIssuedDocumentsDetailed
     */
  function PermissionsFicIssuedDocumentsDetailed() {
    _classCallCheck(this, PermissionsFicIssuedDocumentsDetailed);
  ...
  /**
     ...
     */
  _createClass(PermissionsFicIssuedDocumentsDetailed, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('quotes')) {
          obj.quotes = _PermissionLevel["default"].constructFromObject(data.quotes);
        }
        if (data.hasOwnProperty('proformas')) {
          obj.proformas = _PermissionLevel["default"].constructFromObject(data.proformas);
        }
        if (data.hasOwnProperty('invoices')) {
          obj.invoices = _PermissionLevel["default"].constructFromObject(data.invoices);
        }
        if (data.hasOwnProperty('receipts')) {
          obj.receipts = _PermissionLevel["default"].constructFromObject(data.receipts);
        }
        if (data.hasOwnProperty('delivery_notes')) {
          obj.delivery_notes = _PermissionLevel["default"].constructFromObject(data.delivery_notes);
        }
        if (data.hasOwnProperty('credit_notes')) {
          obj.credit_notes = _PermissionLevel["default"].constructFromObject(data.credit_notes);
        }
        if (data.hasOwnProperty('orders')) {
          obj.orders = _PermissionLevel["default"].constructFromObject(data.orders);
        }
        if (data.hasOwnProperty('work_reports')) {
          obj.work_reports = _PermissionLevel["default"].constructFromObject(data.work_reports);
        }
        if (data.hasOwnProperty('supplier_orders')) {
          obj.supplier_orders = _PermissionLevel["default"].constructFromObject(data.supplier_orders);
        }
        if (data.hasOwnProperty('self_invoices')) {
          obj.self_invoices = _PermissionLevel["default"].constructFromObject(data.self_invoices);
        }
      }
      return obj;
    }
  ...
  return PermissionsFicIssuedDocumentsDetailed;
}();
/**
...
var _default = exports["default"] = PermissionsFicIssuedDocumentsDetailed;