...
var _PaymentMethodType = _interopRequireDefault(require("./PaymentMethodType"));
...
var PaymentMethod = /*#__PURE__*/function () {
  ...
  _createClass(PaymentMethod, null, [{
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('type')) {
          obj.type = _PaymentMethodType["default"].constructFromObject(data.type);
        }
        ...
        if (data.hasOwnProperty('default_payment_account')) {
          obj.default_payment_account = _PaymentAccount["default"].constructFromObject(data.default_payment_account);
        }
        if (data.hasOwnProperty('details')) {
          obj.details = _ApiClient["default"].convertToType(data.details, [_PaymentMethodDetails["default"]]);
        }
        ...
        if (data.hasOwnProperty('ei_payment_method')) {
          obj.ei_payment_method = _ApiClient["default"].convertToType(data.ei_payment_method, 'String');
        }
      }
      return obj;
    }
    ...
    value: function validateJSON(data) {
      ...
      if (data.default_payment_account) {
        // data not null
        _PaymentAccount["default"].validateJSON(data.default_payment_account);
      }
      if (data.details) {
        // data not null
        ...
        try {
          for (_iterator.s(); !(_step = _iterator.n()).done;) {
            ...
            _PaymentMethodDetails["default"].validateJSON(item);
          }
        } catch (err) {
          _iterator.e(err);
        } finally {
