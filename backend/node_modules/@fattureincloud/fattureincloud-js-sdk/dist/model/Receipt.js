...
var _ReceiptItemsListItem = _interopRequireDefault(require("./ReceiptItemsListItem"));
var _ReceiptType = _interopRequireDefault(require("./ReceiptType"));
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('type')) {
          obj.type = _ReceiptType["default"].constructFromObject(data.type);
        }
        ...
        if (data.hasOwnProperty('items_list')) {
          obj.items_list = _ApiClient["default"].convertToType(data.items_list, [_ReceiptItemsListItem["default"]]);
        }
      }
      return obj;
    }
      ...
      if (data.items_list) {
        ...
        try {
          for (_iterator.s(); !(_step = _iterator.n()).done;) {
            ...
            _ReceiptItemsListItem["default"].validateJSON(item);
          }
        } catch (err) {
          _iterator.e(err);
        } finally {
