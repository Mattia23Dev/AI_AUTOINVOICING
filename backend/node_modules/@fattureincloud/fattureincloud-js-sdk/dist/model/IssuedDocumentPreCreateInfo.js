...
var _IssuedDocumentPreCreateInfoDefaultValues = _interopRequireDefault(require("./IssuedDocumentPreCreateInfoDefaultValues"));
var _IssuedDocumentPreCreateInfoExtraDataDefaultValues = _interopRequireDefault(require("./IssuedDocumentPreCreateInfoExtraDataDefaultValues"));
var _IssuedDocumentPreCreateInfoItemsDefaultValues = _interopRequireDefault(require("./IssuedDocumentPreCreateInfoItemsDefaultValues"));
 ...
 * @version 2.0.24
 */
var IssuedDocumentPreCreateInfo = /*#__PURE__*/function () {
  /**
     * Constructs a new <code>IssuedDocumentPreCreateInfo</code>.
     * @alias module:model/IssuedDocumentPreCreateInfo
     */
  function IssuedDocumentPreCreateInfo() {
    _classCallCheck(this, IssuedDocumentPreCreateInfo);
  ...
  /**
     ...
     */
  _createClass(IssuedDocumentPreCreateInfo, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('dn_numerations')) {
          obj.dn_numerations = _ApiClient["default"].convertToType(data.dn_numerations, {
            String: Object
          });
        }
        if (data.hasOwnProperty('default_values')) {
          obj.default_values = _IssuedDocumentPreCreateInfoDefaultValues["default"].constructFromObject(data.default_values);
        }
        if (data.hasOwnProperty('extra_data_default_values')) {
          obj.extra_data_default_values = _IssuedDocumentPreCreateInfoExtraDataDefaultValues["default"].constructFromObject(data.extra_data_default_values);
        }
        if (data.hasOwnProperty('items_default_values')) {
          obj.items_default_values = _IssuedDocumentPreCreateInfoItemsDefaultValues["default"].constructFromObject(data.items_default_values);
        }
        if (data.hasOwnProperty('countries_list')) {
          obj.countries_list = _ApiClient["default"].convertToType(data.countries_list, ['String']);
        }
        if (data.hasOwnProperty('currencies_list')) {
          obj.currencies_list = _ApiClient["default"].convertToType(data.currencies_list, [_Currency["default"]]);
        }
        if (data.hasOwnProperty('templates_list')) {
          obj.templates_list = _ApiClient["default"].convertToType(data.templates_list, [_DocumentTemplate["default"]]);
        }
        if (data.hasOwnProperty('dn_templates_list')) {
          obj.dn_templates_list = _ApiClient["default"].convertToType(data.dn_templates_list, [_DocumentTemplate["default"]]);
        }
        if (data.hasOwnProperty('ai_templates_list')) {
          obj.ai_templates_list = _ApiClient["default"].convertToType(data.ai_templates_list, [_DocumentTemplate["default"]]);
        }
        if (data.hasOwnProperty('payment_methods_list')) {
          obj.payment_methods_list = _ApiClient["default"].convertToType(data.payment_methods_list, [_PaymentMethod["default"]]);
        }
        ...
        if (data.hasOwnProperty('languages_list')) {
          obj.languages_list = _ApiClient["default"].convertToType(data.languages_list, [_Language["default"]]);
        }
      }
      return obj;
    }
    ...
    value: function validateJSON(data) {
      ...
      if (data.default_values) {
        // data not null
        _IssuedDocumentPreCreateInfoDefaultValues["default"].validateJSON(data.default_values);
      }
      // validate the optional field `extra_data_default_values`
      if (data.extra_data_default_values) {
        // data not null
        _IssuedDocumentPreCreateInfoExtraDataDefaultValues["default"].validateJSON(data.extra_data_default_values);
      }
      // validate the optional field `items_default_values`
      if (data.items_default_values) {
        // data not null
        _IssuedDocumentPreCreateInfoItemsDefaultValues["default"].validateJSON(data.items_default_values);
      }
      ...
      if (data.currencies_list) {
        ...
        var _iterator = _createForOfIteratorHelper(data.currencies_list),
          _step;
        try {
      ...
      if (data.templates_list) {
        ...
        var _iterator2 = _createForOfIteratorHelper(data.templates_list),
          _step2;
        try {
          for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
            var _item = _step2.value;
            _DocumentTemplate["default"].validateJSON(_item);
          }
        } catch (err) {
          _iterator2.e(err);
        } finally {
      ...
      if (data.dn_templates_list) {
        ...
        var _iterator3 = _createForOfIteratorHelper(data.dn_templates_list),
          _step3;
        try {
          for (_iterator3.s(); !(_step3 = _iterator3.n()).done;) {
            var _item2 = _step3.value;
            _DocumentTemplate["default"].validateJSON(_item2);
          }
        } catch (err) {
          _iterator3.e(err);
        } finally {
      ...
      if (data.ai_templates_list) {
        ...
        var _iterator4 = _createForOfIteratorHelper(data.ai_templates_list),
          _step4;
        try {
          for (_iterator4.s(); !(_step4 = _iterator4.n()).done;) {
            var _item3 = _step4.value;
            _DocumentTemplate["default"].validateJSON(_item3);
          }
        } catch (err) {
          _iterator4.e(err);
        } finally {
      ...
      if (data.payment_methods_list) {
        ...
        var _iterator5 = _createForOfIteratorHelper(data.payment_methods_list),
          _step5;
        try {
          for (_iterator5.s(); !(_step5 = _iterator5.n()).done;) {
            var _item4 = _step5.value;
            _PaymentMethod["default"].validateJSON(_item4);
          }
        } catch (err) {
          _iterator5.e(err);
        } finally {
      ...
      if (data.payment_accounts_list) {
        ...
        var _iterator6 = _createForOfIteratorHelper(data.payment_accounts_list),
          _step6;
        try {
          for (_iterator6.s(); !(_step6 = _iterator6.n()).done;) {
            var _item5 = _step6.value;
            _PaymentAccount["default"].validateJSON(_item5);
          }
        } catch (err) {
          _iterator6.e(err);
        } finally {
      ...
      if (data.vat_types_list) {
        ...
        var _iterator7 = _createForOfIteratorHelper(data.vat_types_list),
          _step7;
        try {
          for (_iterator7.s(); !(_step7 = _iterator7.n()).done;) {
            var _item6 = _step7.value;
            _VatType["default"].validateJSON(_item6);
          }
        } catch (err) {
          _iterator7.e(err);
        } finally {
      ...
      if (data.languages_list) {
        ...
        var _iterator8 = _createForOfIteratorHelper(data.languages_list),
          _step8;
        try {
          for (_iterator8.s(); !(_step8 = _iterator8.n()).done;) {
            var _item7 = _step8.value;
            _Language["default"].validateJSON(_item7);
          }
        } catch (err) {
          _iterator8.e(err);
        } finally {
  ...
  return IssuedDocumentPreCreateInfo;
}();
/**
...
var _default = exports["default"] = IssuedDocumentPreCreateInfo;