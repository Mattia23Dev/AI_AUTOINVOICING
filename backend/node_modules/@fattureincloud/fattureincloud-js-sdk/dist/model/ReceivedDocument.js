...
var _ReceivedDocumentItemsListItem = _interopRequireDefault(require("./ReceivedDocumentItemsListItem"));
var _ReceivedDocumentPaymentsListItem = _interopRequireDefault(require("./ReceivedDocumentPaymentsListItem"));
var _ReceivedDocumentType = _interopRequireDefault(require("./ReceivedDocumentType"));
...
var ReceivedDocument = /*#__PURE__*/function () {
  ...
  /**
     ...
     */
  _createClass(ReceivedDocument, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('type')) {
          obj.type = _ReceivedDocumentType["default"].constructFromObject(data.type);
        }
        ...
        if (data.hasOwnProperty('amortization')) {
          obj.amortization = _ApiClient["default"].convertToType(data.amortization, 'Number');
        }
        ...
        if (data.hasOwnProperty('is_detailed')) {
          obj.is_detailed = _ApiClient["default"].convertToType(data.is_detailed, 'Boolean');
        }
        ...
        if (data.hasOwnProperty('tax_deductibility')) {
          obj.tax_deductibility = _ApiClient["default"].convertToType(data.tax_deductibility, 'Number');
        }
        if (data.hasOwnProperty('vat_deductibility')) {
          obj.vat_deductibility = _ApiClient["default"].convertToType(data.vat_deductibility, 'Number');
        }
        if (data.hasOwnProperty('items_list')) {
          obj.items_list = _ApiClient["default"].convertToType(data.items_list, [_ReceivedDocumentItemsListItem["default"]]);
        }
        if (data.hasOwnProperty('payments_list')) {
          obj.payments_list = _ApiClient["default"].convertToType(data.payments_list, [_ReceivedDocumentPaymentsListItem["default"]]);
        }
        ...
        if (data.hasOwnProperty('attachment_preview_url')) {
          obj.attachment_preview_url = _ApiClient["default"].convertToType(data.attachment_preview_url, 'String');
        }
        if (data.hasOwnProperty('auto_calculate')) {
          obj.auto_calculate = _ApiClient["default"].convertToType(data.auto_calculate, 'Boolean');
        }
      ...
      if (data.items_list) {
        ...
        try {
          for (_iterator.s(); !(_step = _iterator.n()).done;) {
            ...
            _ReceivedDocumentItemsListItem["default"].validateJSON(item);
          }
        } catch (err) {
          _iterator.e(err);
        } finally {
      ...
      if (data.payments_list) {
        ...
        try {
          for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
            ...
            _ReceivedDocumentPaymentsListItem["default"].validateJSON(_item);
          }
        } catch (err) {
          _iterator2.e(err);
        } finally {
...
var _default = exports["default"] = ReceivedDocument;