 ...
 * @version 2.0.24
 */
var EInvoiceRejectionReason = /*#__PURE__*/function () {
  /**
     * Constructs a new <code>EInvoiceRejectionReason</code>.
     * @alias module:model/EInvoiceRejectionReason
     */
  function EInvoiceRejectionReason() {
    _classCallCheck(this, EInvoiceRejectionReason);
  ...
  /**
     ...
     */
  _createClass(EInvoiceRejectionReason, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('solution')) {
          obj.solution = _ApiClient["default"].convertToType(data.solution, 'String');
        }
  ...
  return EInvoiceRejectionReason;
}();
/**
...
var _default = exports["default"] = EInvoiceRejectionReason;