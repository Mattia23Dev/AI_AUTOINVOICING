...
var _CashbookEntryDocument = _interopRequireDefault(require("./CashbookEntryDocument"));
var _CashbookEntryKind = _interopRequireDefault(require("./CashbookEntryKind"));
var _CashbookEntryType = _interopRequireDefault(require("./CashbookEntryType"));
 ...
 * @version 2.0.24
 */
var CashbookEntry = /*#__PURE__*/function () {
  /**
     * Constructs a new <code>CashbookEntry</code>.
     * @alias module:model/CashbookEntry
     */
  function CashbookEntry() {
    _classCallCheck(this, CashbookEntry);
  ...
  /**
     ...
     */
  _createClass(CashbookEntry, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('kind')) {
          obj.kind = _CashbookEntryKind["default"].constructFromObject(data.kind);
        }
        if (data.hasOwnProperty('type')) {
          obj.type = _CashbookEntryType["default"].constructFromObject(data.type);
        }
        if (data.hasOwnProperty('entity_name')) {
          obj.entity_name = _ApiClient["default"].convertToType(data.entity_name, 'String');
        }
        if (data.hasOwnProperty('document')) {
          obj.document = _CashbookEntryDocument["default"].constructFromObject(data.document);
        }
        if (data.hasOwnProperty('amount_in')) {
          obj.amount_in = _ApiClient["default"].convertToType(data.amount_in, 'Number');
        }
        if (data.hasOwnProperty('payment_account_in')) {
          obj.payment_account_in = _PaymentAccount["default"].constructFromObject(data.payment_account_in);
        }
        if (data.hasOwnProperty('amount_out')) {
          obj.amount_out = _ApiClient["default"].convertToType(data.amount_out, 'Number');
        }
        if (data.hasOwnProperty('payment_account_out')) {
          obj.payment_account_out = _PaymentAccount["default"].constructFromObject(data.payment_account_out);
        }
      }
      return obj;
    }
    ...
    value: function validateJSON(data) {
      ...
      if (data.document) {
        // data not null
        _CashbookEntryDocument["default"].validateJSON(data.document);
      }
      // validate the optional field `payment_account_in`
      if (data.payment_account_in) {
        // data not null
        _PaymentAccount["default"].validateJSON(data.payment_account_in);
      }
      // validate the optional field `payment_account_out`
      if (data.payment_account_out) {
        // data not null
        _PaymentAccount["default"].validateJSON(data.payment_account_out);
      }
      return true;
    }
  }]);
...
var _default = exports["default"] = CashbookEntry;