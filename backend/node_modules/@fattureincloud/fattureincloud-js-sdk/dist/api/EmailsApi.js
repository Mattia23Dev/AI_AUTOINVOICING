...
var EmailsApi = exports["default"] = /*#__PURE__*/function () {
  ...
  _createClass(EmailsApi, [{
    key: "listEmailsWithHttpInfo",
    value: function listEmailsWithHttpInfo(companyId) {
      var postBody = null;
      ...
      var returnType = _ListEmailsResponse["default"];
      return this.apiClient.callApi('/c/{company_id}/emails', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
    }
    ...
    key: "listEmails",
    value: function listEmails(companyId) {
      return this.listEmailsWithHttpInfo(companyId).then(function (response_and_data) {
