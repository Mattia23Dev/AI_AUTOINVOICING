...
var UserApi = exports["default"] = /*#__PURE__*/function () {
  ...
  _createClass(UserApi, [{
    key: "getUserInfoWithHttpInfo",
    value: function getUserInfoWithHttpInfo() {
      var postBody = null;
      var pathParams = {};
      var queryParams = {};
      var headerParams = {};
      ...
      return this.apiClient.callApi('/user/info', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
    }
    ...
    value: function getUserInfo() {
      return this.getUserInfoWithHttpInfo().then(function (response_and_data) {
    ...
    key: "listUserCompaniesWithHttpInfo",
    value: function listUserCompaniesWithHttpInfo() {
      var postBody = null;
      var pathParams = {};
      var queryParams = {};
      var headerParams = {};
      ...
      var contentTypes = [];
      var accepts = ['application/json'];
      var returnType = _ListUserCompaniesResponse["default"];
      return this.apiClient.callApi('/user/companies', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
    }
    ...
    value: function listUserCompanies() {
      return this.listUserCompaniesWithHttpInfo().then(function (response_and_data) {
        return response_and_data.data;
      });
    }
  }]);
