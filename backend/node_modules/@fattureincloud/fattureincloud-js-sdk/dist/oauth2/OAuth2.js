...
var OAuth2AuthorizationCodeManager = exports["default"] = /*#__PURE__*/function () {
  ...
  _createClass(OAuth2AuthorizationCodeManager, [{
    ...
    value: function refreshToken(_refreshToken) {
      ...
      var res = this.tokenRequest(tokenUri, data);
      return new _OAuth2AuthorizationCodeTokenResponse["default"](res.token_type, res.access_token, res.refresh_token, res.expires_in);
    }
  }, {
    key: "tokenRequest",
    value: function tokenRequest(uri, data) {
      return _superagent["default"].post(uri).send(data).then(function (d) {
        return d.body;
      })["catch"](function (e) {
