 ...
 */
var Condition = exports["default"] = /*#__PURE__*/function (_Expression) {
  ...
  function Condition(field, operator, value) {
    ...
    /**
       ...
       */
    _defineProperty(_assertThisInitialized(_this), "operator", void 0);
    /**
  ...
  _createClass(Condition, [{
    ...
    value: function buildQuery() {
      ...
      if (this.value == null) {
        return "".concat(this.field, " ").concat(this.operator, " null");
      }
      if (typeof this.value === 'string') {
        return "".concat(this.field, " ").concat(this.operator, " '").concat(this.value, "'");
      } else {
        return "".concat(this.field, " ").concat(this.operator, " ").concat(this.value);
      }
    }
